...
class UserProfileModelTests(TestCase):
    ...
    def test_user_profile_model_basic(self):
        ...
        user2 = User.objects.create(
            username="other-user", email="other@gmail.com"
        )
    ...
    def test_user_profile_get_display_id(self):
        ...
        user = User.objects.create(
            username="john.doe@example.com", email="otheraddress@example.com"
        )
...
class LinkedEmailModelTests(TestCase):
    ...
    def test_linked_email_model_basic(self):
        ...
        """
        user = User.objects.create(username="new-user")
        linked_email = LinkedEmail.objects.create(
        ...
        result = LinkedEmail.objects.get(
            profile=user.uniauth_profile, address="example@gmail.com"
        )
    ...
    def test_linked_email_model_clean(self):
        ...
        with self.settings(UNIAUTH_ALLOW_SHARED_EMAILS=False):
            ...
            try:
                ...
                email.save()
                self.fail(
                    "Adding shared email address succeeded when "
            ...
            self.assertFalse(
                LinkedEmail.objects.filter(
                    profile=user2.uniauth_profile, address="shared@example.com"
                ).exists()
            )
...
class InstitutionAccountModelTests(TestCase):
    ...
    def test_institution_account_model_basic(self):
        ...
        result = InstitutionAccount.objects.get(
